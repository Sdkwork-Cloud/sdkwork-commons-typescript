...
class SdkStream {
     ...
     */
    static async streamRequest(url, options = {}, client) {
        const controller = new AbortController();
        // Merge the abort signal with options
        ...
        try {
            ...
            if (contentType && contentType.includes('text/event-stream')) {
                return SdkStream.fromSSEResponse(response, controller, client);
            }
            else {
                // Handle as regular JSON stream
                return SdkStream.fromReadableStream(response.body, controller, client);
            }
        }
        catch (error) {
            controller.abort();
